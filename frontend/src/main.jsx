...
// Escape HTML special chars to prevent injection inside terminal rendering
function escapeHtml(str){
  return String(str).replace(/[&<>"]|'/g, c => ({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;','\'':'&#39;'}[c]));
}

// Minimal ANSI SGR color/intensity parser converting to <span> with classes.
// Supports common color codes 30-37 / 90-97 foreground and 1 (bold), 0/39 reset.
